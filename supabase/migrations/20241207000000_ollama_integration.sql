-- Ollama Integration Migration for FlameForge Nexus
...
-- Create index for execution status
CREATE INDEX IF NOT EXISTS idx_workbench_nodes_execution_status ON workbench_nodes(execution_status);
